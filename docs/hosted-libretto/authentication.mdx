...
The CLI prompts for your name, email, password, organization name, and organization slug. After the account is created, it waits for email verification and stores the hosted session locally in `~/.libretto/auth.json`.
