...
<Warning>
  Converting to network requests is an optimization, not a starting point. Make
  sure you have a working browser-based workflow first — you need it to capture
  the network traffic that reveals the API endpoints. If you don't have a
  working script yet, start with [one-shot
  generation](./one-shot-script-generation) or [interactive script
  building](./interactive-script-building).
</Warning>
...
### When to stay with browser automation
