...
Install the Libretto command once, then use `libretto` from any shell. This requires Node.js and npm on your machine.
...
<Steps>
  ...
  <Step title="Run it">
    ```bash
    libretto run src/workflows/scrape-page.ts
    ```
