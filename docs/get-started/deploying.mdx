...
"og:image": "https://libretto.sh/docs/og/get-started/deploying.png"
---
...
>
> Then:
> - If I choose managed hosting, follow the Libretto Cloud Hosting docs to authenticate, deploy privately, and run the workflow with jobs/create. Do not publish externally (open workflows or hosted public run APIs); that is UI-only for humans.
