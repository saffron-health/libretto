...
"og:image": "https://libretto.sh/docs/og/get-started/quickstart.png"
---
...
<CardGroup cols={3}>
  <Card title="Libretto vs Browser Use" icon="lucide:monitor" href="https://libretto.sh/vs/browser-use">
