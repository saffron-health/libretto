---
title: Add Libretto to an existing project
sidebarTitle: Add to an existing project
---

If you already have a Node.js project and want to add Libretto to it, follow these steps.

<Note>
  Starting from scratch? See [Create a new Libretto project](./create-new-libretto-project) to
