...
For the hosted public app path, first connect the repository to Libretto Cloud.
The connect flow verifies the GitHub user can access the installed Libretto
