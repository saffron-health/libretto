...
Most Libretto Cloud API routes in this section are `POST` requests. Hosted
...
Hosted workflow routes use direct JSON bodies as shown on the
[Hosted workflows](/libretto-cloud-api/hosted-workflows) page.
...
<CardGroup cols={2}>
  ...
  <Card title="Hosted Workflows" icon="lucide:library" href="/libretto-cloud-api/hosted-workflows">
    Search, run, and save workflows published by other tenants.
  </Card>
