...
Published workflow routes use direct JSON bodies as shown on the
[Published workflows](/libretto-cloud-api/hosted-workflows) page.
...
<CardGroup cols={2}>
  ...
  <Card title="Published Workflows" icon="lucide:library" href="/libretto-cloud-api/hosted-workflows">
