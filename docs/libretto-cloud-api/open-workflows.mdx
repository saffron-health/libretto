...
Publishing a new open workflow is a human action in the website dashboard. See [Sharing workflows externally](/libretto-cloud-hosting/sharing-workflows-externally). Do not confuse this with private deploy (your own ready deployment, run with [jobs/create](/libretto-cloud-api/jobs-and-logs#jobs)).
