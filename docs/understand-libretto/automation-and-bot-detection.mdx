...
"og:image": "https://libretto.sh/docs/og/understand-libretto/automation-and-bot-detection.png"
---
...
<Tabs>
  <Tab title="Regular Playwright">
    ...
    * Integrates directly with Libretto's step-based workflow and recovery features
...
* You want the simplest implementation that integrates with Libretto's recovery features
