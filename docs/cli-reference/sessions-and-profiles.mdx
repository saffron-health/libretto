...
Structured CLI and system logs. Contains debug output from Libretto itself, including command execution, errors, and internal events.
...
Profiles save browser sessions (cookies and localStorage) so you can reuse authenticated state across runs without logging in every time.
...
<CardGroup cols={2}>
  <Card title="Automation & bot detection" icon="code" href="../get-started/automation-approaches">
    Compare integration strategies and their detection risk profiles.
  </Card>
</CardGroup>
