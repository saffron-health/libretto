...
<CardGroup cols={3}>
  ...
  <Card title="Sharing externally" icon="share-2" href="/libretto-cloud-hosting/sharing-workflows-externally">
...
Private deploy and run (the usual path after setup above) use [Deployments and Workflows](/libretto-cloud-api/deployments-and-workflows) and [Jobs and Logs](/libretto-cloud-api/jobs-and-logs). To share source or host a public opaque run API from the website, see [Sharing workflows externally](/libretto-cloud-hosting/sharing-workflows-externally).
