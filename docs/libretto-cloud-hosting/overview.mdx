...
<CardGroup cols={3}>
  ...
  <Card title="Data retention" icon="clock" href="/libretto-cloud-hosting/data-retention">
    How long Libretto Cloud keeps job results, logs, and debug artifacts.
  </Card>
...
To share a workflow outside your workspace from the dashboard, see [Sharing workflows externally](/libretto-cloud-hosting/sharing-workflows-externally).
