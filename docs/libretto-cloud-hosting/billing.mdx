...
Job results stay for the life of your workspace. See [Data retention](/libretto-cloud-hosting/data-retention) for screenshots, logs, recordings, and custom retention.
...
(which does not require an Enterprise plan), a custom data retention period,
or an Enterprise plan, please reach out to us at `team@libretto.sh`.
