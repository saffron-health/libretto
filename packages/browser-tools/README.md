...
See the [MCP adapter docs](https://libretto.sh/docs/browser-tools/adapters/mcp) for flags (including `--provider`) and the library API. Host guides: [Hermes](https://libretto.sh/docs/browser-tools/agents/hermes), [OpenClaw](https://libretto.sh/docs/browser-tools/agents/openclaw).
