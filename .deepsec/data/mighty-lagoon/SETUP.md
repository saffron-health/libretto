# Agent setup for `mighty-lagoon`

This is a deepsec scanning workspace. Project `mighty-lagoon` was just registered
(target: `..`). Setup is incomplete — `data/mighty-lagoon/INFO.md`
...
2. **Fill in `data/mighty-lagoon/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id mighty-lagoon
pnpm deepsec process --project-id mighty-lagoon
```
