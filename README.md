...
<p align="center">
  <img src="packages/libretto/assets/readme-banner.png" alt="Libretto" />
</p>
...
The install id is stored in the telemetry file at `~/.libretto/telemetry.json`. The implementation lives in [`packages/libretto/src/cli/core/telemetry.ts`](packages/libretto/src/cli/core/telemetry.ts). To disable telemetry, set `LIBRETTO_TELEMETRY_DISABLED=1`.
