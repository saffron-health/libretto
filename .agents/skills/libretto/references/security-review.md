...
Use this reference to assess a live site before choosing whether to extract data through browser-context fetch calls, passive network interception, or DOM extraction.

After completing the probes below, produce a Website Security Assessment Summary (see the output format at the end of this document).
